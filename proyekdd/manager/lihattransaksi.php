...
$sql = 'SELECT ht.HTRANS_ID as hid, ht.TRANSACTION_DATE as datee, e."Name" as emplonama, c."Name" as custnama, ht.TOTAL as totale FROM system.HTRANS ht, system.employee e, system.customer c where ht.employee_id = e.employee_id and c.customer_id = c.customer_id';
